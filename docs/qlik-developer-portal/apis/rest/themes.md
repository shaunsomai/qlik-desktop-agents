...
```bash
# qlik-cli has not implemented support for GET /api/v1/themes yet.
```
...
```bash
# qlik-cli has not implemented support for POST /api/v1/themes yet.
```
...
```bash
# qlik-cli has not implemented support for GET /api/v1/themes/{id} yet.
```
...
```bash
# qlik-cli has not implemented support for PATCH /api/v1/themes/{id} yet.
```
...
```bash
# qlik-cli has not implemented support for DELETE /api/v1/themes/{id} yet.
```
...
```bash
# qlik-cli has not implemented support for GET /api/v1/themes/{id}/file yet.
```
...
```bash
# qlik-cli has not implemented support for GET /api/v1/themes/{id}/file/{filepath} yet.
```
