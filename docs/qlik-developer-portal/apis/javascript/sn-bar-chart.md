---
source: https://qlik.dev/apis/javascript/sn-bar-chart/
...
- [ContinuousDimensionProperties](#continuousdimensionproperties-object)
...
- [FirstDimensionDiffAttributes](#firstdimensiondiffattributes-object)
...
| `showSegmentLabels` | boolean | Yes | false | Show segment labels |
| `showTotalLabels` | boolean | Yes | true | Show total labels |
...
### ContinuousDimensionProperties `object`

#### Properties

| Name | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `period` | 'auto' \| 'seconds' \| 'minutes' \| 'hours' \| 'days' \| 'weeks' \| 'months' \| 'years' \| 'number' \| 'none' | Yes | "auto" | Defines the base unit for the dimension's step or interval. This is combined with 'stepSize' to determine the final step duration or magnitude. |
| `stepSize` | number | Yes | 1 | The step size for the 'period', defining the total step magnitude or duration. For time-based 'period's, this specifies the number of base units (e.g., 3 for a quarter when combined with 'month'). For 'number', it is the numeric increment. |
...
### FirstDimensionDiffAttributes `object`
...
| Name | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `id` | string | Yes | - | One of: `firstDimensionDiff`: calculates the minimum value of the differences between the adjacent values of the first dimension. This serves as a unit or period of the first dimension. |
...
| Name | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `continuous` | [ContinuousDimensionProperties](#continuousdimensionproperties-object) | Yes | - |  |
