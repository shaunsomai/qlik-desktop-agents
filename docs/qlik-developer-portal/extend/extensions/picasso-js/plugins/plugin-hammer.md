---
source: https://qlik.dev/extend/extensions/picasso-js/plugins/plugin-hammer/
...
in a declarative way. For more information, see the [Hammer API documentation](http://hammerjs.github.io/api/)
...
> [HammerJS](http://hammerjs.github.io/api/) has to be loaded to be able to use
> this plugin so that the Hammer variable is available on the global namespace.
