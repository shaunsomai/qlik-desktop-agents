---
source: https://qlik.dev/toolkits/qlik-cli/condition/condition-edit/
...
Modify a condition interactively in a text-editor

### Synopsis

Modify a condition interactively in a text-editor

This command will fetch a condition and open it in the editor 'vi'.
...
```
qlik condition edit <conditionId> [flags]
```
