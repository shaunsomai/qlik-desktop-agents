---
source: https://qlik.dev/toolkits/qlik-cli/oauth-client/oauth-client-connection-config-patch/
last_updated: 2026-06-03T09:30:31+02:00
---

# oauth-client connection-config patch

## qlik oauth-client connection-config patch
...
```
qlik oauth-client connection-config patch <oauth-clientId> [flags]
```
