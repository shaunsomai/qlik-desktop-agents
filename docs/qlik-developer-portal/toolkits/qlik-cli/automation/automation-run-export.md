---
source: https://qlik.dev/toolkits/qlik-cli/automation/automation-run-export/
last_updated: 2026-06-03T09:30:31+02:00
---

# automation run export

## qlik automation run export
...
```
qlik automation run export [flags]
```
