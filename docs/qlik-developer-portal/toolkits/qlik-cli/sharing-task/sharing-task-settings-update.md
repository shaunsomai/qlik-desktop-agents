---
source: https://qlik.dev/toolkits/qlik-cli/sharing-task/sharing-task-settings-update/
last_updated: 2026-06-03T09:30:31+02:00
---

# sharing-task settings update

## qlik sharing-task settings update
...
```
qlik sharing-task settings update [flags]
```
...
```
  ...
  -h, --help            help for update
      ...
      --path string     The path for the given resource field to patch.
                        Allowed values: "/enable-sharing", "/enable-report-subscription"
