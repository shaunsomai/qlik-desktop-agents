---
source: https://qlik.dev/toolkits/qlik-cli/di-project/di-project-di-task-runtime-state-datasets/
last_updated: 2026-06-03T09:30:31+02:00
---

# di-project di-task runtime state-datasets
...
```
qlik di-project di-task runtime state-datasets [flags]
```
...
```
  ...
  -h, --help                  help for state-datasets
