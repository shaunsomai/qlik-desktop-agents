---
source: https://qlik.dev/toolkits/qlik-cli/di-project/di-project-di-task-prepare/
last_updated: 2026-06-03T09:30:31+02:00
---

# di-project di-task prepare
...
```
qlik di-project di-task prepare [flags]
```

### Options

```
      --allowRecreate         (Required) Allow recreation of existing artifacts
