---
source: https://qlik.dev/toolkits/qlik-cli/tenant/tenant-edit/
...
Modify a tenant interactively in a text-editor

### Synopsis

Modify a tenant interactively in a text-editor

This command will fetch a tenant and open it in the editor 'vi'.
...
```
qlik tenant edit <tenantId> [flags]
```
