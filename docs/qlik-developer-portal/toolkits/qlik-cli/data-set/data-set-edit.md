---
source: https://qlik.dev/toolkits/qlik-cli/data-set/data-set-edit/
...
Modify a data-set interactively in a text-editor

### Synopsis

Modify a data-set interactively in a text-editor

This command will fetch a data-set and open it in the editor 'vi'.
...
```
qlik data-set edit <data-setId> [flags]
```
