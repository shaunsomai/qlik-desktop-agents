---
source: https://qlik.dev/toolkits/qlik-cli/direct-access-agent/direct-access-agent-connector-file-allowed-paths-get/
last_updated: 2026-06-03T09:30:31+02:00
---

# direct-access-agent connector file allowed-paths get
...
```
qlik direct-access-agent connector file allowed-paths get <direct-access-agentId> [flags]
```
