---
source: https://qlik.dev/toolkits/qlik-cli/direct-access-agent/direct-access-agent-connector-file-ls/
last_updated: 2026-06-03T09:30:31+02:00
---

# direct-access-agent connector file ls
...
```
qlik direct-access-agent connector file ls [flags]
```

### Options

```
      --connectorType string           (Required) The connector to retrieve the list of files for
