---
source: https://qlik.dev/toolkits/qlik-cli/direct-access-agent/direct-access-agent-connector-file-update/
last_updated: 2026-06-03T09:30:31+02:00
---

# direct-access-agent connector file update
...
```
qlik direct-access-agent connector file update <fileType> [flags]
```

### Options

```
      --connectorType string           (Required) The connector type to update
      --contentsToSave strings         
