---
source: https://qlik.dev/toolkits/qlik-cli/glossary/glossary-category-ls/
last_updated: 2025-06-18T09:34:47+02:00
---

# glossary category ls

## qlik glossary category ls
...
```
qlik glossary category ls [flags]
```
...
```
  ...
  -q, --quiet               Return only IDs from the command
      ...
      --sort string         Optional resource field name to sort on, eg. name. Can be prefixed with +/- to determine order, defaults to (+) ascending.
                            Allowed values: "description", "+description", "-description", "name", "+name", "-name", "update", "+update", "-update"
```
