---
source: https://qlik.dev/toolkits/qlik-cli/glossary/glossary-edit/
...
Modify a glossary interactively in a text-editor

### Synopsis

Modify a glossary interactively in a text-editor

This command will fetch a glossary and open it in the editor 'vi'.
...
```
qlik glossary edit <glossaryId> [flags]
```
