---
source: https://qlik.dev/toolkits/qlik-cli/glossary/glossary-term-link-ls/
last_updated: 2025-06-18T09:34:47+02:00
---

# glossary term link ls

## qlik glossary term link ls
...
```
qlik glossary term link ls [flags]
```
...
```
  ...
  -q, --quiet               Return only IDs from the command
      ...
      --sort string         Optional resource field name to sort on, eg. name. Can be prefixed with +/- to determine order, defaults to (+) ascending.
                            Allowed values: "type", "+type", "-type", "subtype", "+subtype", "-subtype", "created", "+created", "-created"
