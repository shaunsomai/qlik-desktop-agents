---
source: https://qlik.dev/toolkits/qlik-cli/identity-provider/identity-provider--well-known-metadata-json/
last_updated: 2025-06-18T09:34:47+02:00
---

# identity-provider well-known metadatajson
...
```
qlik identity-provider .well-known metadata.json [flags]
```

### Options

```
  -h, --help           help for metadata.json
