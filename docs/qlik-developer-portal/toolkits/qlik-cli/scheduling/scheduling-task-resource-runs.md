---
source: https://qlik.dev/toolkits/qlik-cli/scheduling/scheduling-task-resource-runs/
last_updated: 2026-06-03T09:30:31+02:00
---

# scheduling task resource-runs

## qlik scheduling task resource-runs
...
```
qlik scheduling task resource-runs <resourceId> [flags]
```

### Options

```
  -h, --help           help for resource-runs
