---
source: https://qlik.dev/toolkits/qlik-cli/scheduling/scheduling-task-create/
last_updated: 2026-06-03T09:30:31+02:00
---

# scheduling task create
...
```
qlik scheduling task create [flags]
```
...
```
  ...
  -h, --help                                                      help for create
      ...
      --migrateFrom string                                        When provided, specifies the unique identifier of a legacy reload-task to migrate from the previous scheduling system.
