---
source: https://qlik.dev/toolkits/qlik-cli/role/role-edit/
...
Modify a role interactively in a text-editor

### Synopsis

Modify a role interactively in a text-editor

This command will fetch a role and open it in the editor 'vi'.
