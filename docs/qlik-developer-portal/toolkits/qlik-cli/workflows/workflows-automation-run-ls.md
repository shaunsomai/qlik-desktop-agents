---
source: https://qlik.dev/toolkits/qlik-cli/workflows/workflows-automation-run-ls/
last_updated: 2026-06-03T09:30:31+02:00
---

# workflows automation run ls

## qlik workflows automation run ls
...
```
qlik workflows automation run ls [flags]
```
