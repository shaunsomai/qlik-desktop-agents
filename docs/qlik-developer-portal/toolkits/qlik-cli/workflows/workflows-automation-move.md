---
source: https://qlik.dev/toolkits/qlik-cli/workflows/workflows-automation-move/
last_updated: 2026-06-03T09:30:31+02:00
---

# workflows automation move

## qlik workflows automation move
...
```
qlik workflows automation move <automationId> [flags]
```
...
```
  ...
  -q, --quiet           Return only IDs from the command
      ...
      --userId string   (Required) Unique identifier of the new owner of the automation.
```
