---
source: https://qlik.dev/toolkits/qlik-cli/workflows/workflows-automation-run-get/
last_updated: 2026-06-03T09:30:31+02:00
---

# workflows automation run get

## qlik workflows automation run get
...
```
qlik workflows automation run get <runId> [flags]
```
