---
source: https://qlik.dev/toolkits/qlik-cli/workflows/workflows-automation-rm/
last_updated: 2026-06-03T09:30:31+02:00
---

# workflows automation rm

## qlik workflows automation rm
...
```
qlik workflows automation rm <automationId> [flags]
```
