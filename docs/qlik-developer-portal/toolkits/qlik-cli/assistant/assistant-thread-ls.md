---
source: https://qlik.dev/toolkits/qlik-cli/assistant/assistant-thread-ls/
last_updated: 2025-06-18T09:34:47+02:00
---

# assistant thread ls

## qlik assistant thread ls
...
```
qlik assistant thread ls [flags]
```

### Options

```
      --assistantId string   (Required) The ID of the assistant from which to retrieve threads.
      --filter string        Optional parameter to filter threads.
  -h, --help                 help for ls
  ...
  -q, --quiet                Return only IDs from the command
      ...
      --sort string          Optional resource field name to sort on, case insensitive, e.g. ˋnameˋ. Can be prefixed with ˋ-ˋ to set descending order; defaults to ascending.
                             Allowed values: "NAME", "-NAME", "CREATED", "-CREATED", "UPDATED", "-UPDATED"
```
