---
source: https://qlik.dev/toolkits/qlik-cli/assistant/assistant-edit/
...
Modify a assistant interactively in a text-editor

### Synopsis

Modify a assistant interactively in a text-editor

This command will fetch a assistant and open it in the editor 'vi'.
...
```
qlik assistant edit <assistantId> [flags]
```
