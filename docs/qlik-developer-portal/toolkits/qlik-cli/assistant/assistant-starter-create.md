---
source: https://qlik.dev/toolkits/qlik-cli/assistant/assistant-starter-create/
last_updated: 2026-06-03T09:30:31+02:00
---

# assistant starter create

## qlik assistant starter create
...
```
qlik assistant starter create [flags]
```

### Options

```
      --additionalContext string                         Optional context collected from curated meant to be leveraged by LLM-based question recommendation system.
      --assistantId string                               (Required) The ID of the assistant in which to create the starter.
