---
source: https://qlik.dev/toolkits/qlik-cli/webhook/webhook-edit/
...
Modify a webhook interactively in a text-editor

### Synopsis

Modify a webhook interactively in a text-editor

This command will fetch a webhook and open it in the editor 'vi'.
...
```
qlik webhook edit <webhookId> [flags]
```
