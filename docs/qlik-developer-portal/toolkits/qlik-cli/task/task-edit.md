---
source: https://qlik.dev/toolkits/qlik-cli/task/task-edit/
...
Modify a task interactively in a text-editor

### Synopsis

Modify a task interactively in a text-editor

This command will fetch a task and open it in the editor 'vi'.
