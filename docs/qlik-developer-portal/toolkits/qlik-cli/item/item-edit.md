---
source: https://qlik.dev/toolkits/qlik-cli/item/item-edit/
...
Modify a item interactively in a text-editor

### Synopsis

Modify a item interactively in a text-editor

This command will fetch a item and open it in the editor 'vi'.
