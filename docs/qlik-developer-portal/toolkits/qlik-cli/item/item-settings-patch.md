---
source: https://qlik.dev/toolkits/qlik-cli/item/item-settings-patch/
...
```
qlik item settings patch [flags]
```
...
```
  ...
  -h, --help            help for patch
      ...
      --path string     Field of Settings to be patched (updated).
                        Allowed values: "/usageMetricsEnabled"
