---
source: https://qlik.dev/toolkits/qlik-cli/brand/brand-edit/
...
Modify a brand interactively in a text-editor

### Synopsis

Modify a brand interactively in a text-editor

This command will fetch a brand and open it in the editor 'vi'.
