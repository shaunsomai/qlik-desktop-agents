---
source: https://qlik.dev/toolkits/qlik-cli/space/space-edit/
...
Modify a space interactively in a text-editor

### Synopsis

Modify a space interactively in a text-editor

This command will fetch a space and open it in the editor 'vi'.
