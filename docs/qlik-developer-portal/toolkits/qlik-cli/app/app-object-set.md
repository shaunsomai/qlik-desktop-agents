---
source: https://qlik.dev/toolkits/qlik-cli/app/app-object-set/
...
```
qlik app object set <glob-pattern-path-to-objects-files.json [flags]
```

### Examples

```
qlik app object set ./my-objects-glob-path.json
```
