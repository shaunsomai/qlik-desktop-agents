---
source: https://qlik.dev/toolkits/qlik-cli/app/app-bookmark-layout/
last_updated: 2025-06-18T09:34:47+02:00
---

# app bookmark layout

## qlik app bookmark layout
...
```
qlik app bookmark layout <bookmark-id> [flags]
```

### Examples

```
qlik app bookmark layout \<bookmark-id\>
```
