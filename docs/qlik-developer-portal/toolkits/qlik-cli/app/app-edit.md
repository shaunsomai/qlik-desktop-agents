---
source: https://qlik.dev/toolkits/qlik-cli/app/app-edit/
...
Modify a app interactively in a text-editor

### Synopsis

Modify a app interactively in a text-editor

This command will fetch a app and open it in the editor 'vi'.
