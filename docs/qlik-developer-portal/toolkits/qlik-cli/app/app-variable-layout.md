---
source: https://qlik.dev/toolkits/qlik-cli/app/app-variable-layout/
last_updated: 2025-06-18T09:34:47+02:00
---

# app variable layout

## qlik app variable layout
...
```
qlik app variable layout <variable-id> [flags]
```

### Examples

```
qlik app variable layout VARIABLE-NAME
```
