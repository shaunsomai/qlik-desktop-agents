---
source: https://qlik.dev/toolkits/qlik-cli/app/app-dimension-set/
last_updated: 2025-06-18T09:34:47+02:00
---

# app dimension set

## qlik app dimension set
...
```
qlik app dimension set <glob-pattern-path-to-dimensions-files.json> [flags]
```
