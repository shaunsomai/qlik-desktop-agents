---
source: https://qlik.dev/toolkits/qlik-cli/ml/ml-deployment-realtime-prediction/
last_updated: 2025-06-18T09:34:47+02:00
---

# ml deployment realtime-prediction

## qlik ml deployment realtime-prediction
...
```
qlik ml deployment realtime-prediction <deploymentId> [flags]
```
...
```
  ...
  -h, --help                        help for realtime-prediction
      ...
      --includeShap                 If true, shapley values included in response
