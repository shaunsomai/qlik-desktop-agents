---
source: https://qlik.dev/toolkits/qlik-cli/ml/ml-deployment-alias-patch/
last_updated: 2026-06-03T09:30:31+02:00
---

# ml deployment alias patch

## qlik ml deployment alias patch
...
```
qlik ml deployment alias patch <aliaseId> [flags]
```
