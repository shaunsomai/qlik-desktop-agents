---
source: https://qlik.dev/toolkits/qlik-cli/api-key/api-key-config-edit/
...
Modify a api-key config interactively in a text-editor

### Synopsis

Modify a api-key config interactively in a text-editor

This command will fetch a api-key config and open it in the editor 'vi'.
...
```
qlik api-key config edit <configId> [flags]
```
