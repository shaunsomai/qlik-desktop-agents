---
source: https://qlik.dev/toolkits/qlik-cli/api-key/api-key-edit/
...
Modify a api-key interactively in a text-editor

### Synopsis

Modify a api-key interactively in a text-editor

This command will fetch a api-key and open it in the editor 'vi'.
...
```
qlik api-key edit <api-keyId> [flags]
```
