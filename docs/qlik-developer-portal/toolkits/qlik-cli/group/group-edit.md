---
source: https://qlik.dev/toolkits/qlik-cli/group/group-edit/
...
Modify a group interactively in a text-editor

### Synopsis

Modify a group interactively in a text-editor

This command will fetch a group and open it in the editor 'vi'.
