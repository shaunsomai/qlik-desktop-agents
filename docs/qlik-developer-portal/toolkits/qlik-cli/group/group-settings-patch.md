---
source: https://qlik.dev/toolkits/qlik-cli/group/group-settings-patch/
...
```
qlik group settings patch [flags]
```
...
```
  ...
  -h, --help                help for patch
      ...
      --path string         A JSON Pointer.
                            Allowed values: "/autoCreateGroups", "/syncIdpGroups", "/systemGroups/{id}/assignedRoles"
