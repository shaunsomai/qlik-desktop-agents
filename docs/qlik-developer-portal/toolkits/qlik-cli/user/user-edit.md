---
source: https://qlik.dev/toolkits/qlik-cli/user/user-edit/
...
Modify a user interactively in a text-editor

### Synopsis

Modify a user interactively in a text-editor

This command will fetch a user and open it in the editor 'vi'.
