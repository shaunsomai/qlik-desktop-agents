...
The install instructions use HTTPS to avoid requiring SSH host-key setup, and sparse checkout to avoid Windows path-length failures in the large documentation library. Full documentation remains available in normal repository clones.
